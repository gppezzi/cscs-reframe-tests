...
- Generated: `2026-06-10 18:46:18 +0200`

### libraries/io

| Test name | daint-maint | daint-prod | eiger-maint | eiger-prod | santis-maint | santis-prod | clariden-maint | clariden-prod | starlex-maint | starlex-prod |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
...
| Test name | daint-maint | daint-prod | eiger-maint | eiger-prod | santis-maint | santis-prod | clariden-maint | clariden-prod | starlex-maint | starlex-prod |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [MPIIntranodePinned](../checks/prgenv/cuda/cuda_mpi_intranode_pinned.py)<br><details><summary>🔽 4 variants</summary><br>- %mem=host<br>- %mem=pinned_host<br>- %mpich_smp_single_copy_mode=CMA<br>- %mpich_smp_single_copy_mode=XPMEM</details> | ✅ | ❌ | ❌ | ❌ | ✅ | ❌ | ✅ | ❌ | ✅ | ❌ |
...
| Test name | daint-maint | daint-prod | eiger-maint | eiger-prod | santis-maint | santis-prod | clariden-maint | clariden-prod | starlex-maint | starlex-prod |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [NCCLTestsCE](../checks/microbenchmarks/xccl/xccl_tests.py)<br><details><summary>🔽 2 variants</summary><br>- %image_tag=cuda12.9.1-ubuntu24.04<br>- %test_name=all_reduce<br>- %test_name=sendrecv</details> | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| Test name | daint-maint | daint-prod | eiger-maint | eiger-prod | santis-maint | santis-prod | clariden-maint | clariden-prod | starlex-maint | starlex-prod |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| [VaspBuildCheckUENV](../checks/apps/vasp/vasp_check_uenv.py)<br><details><summary>🔽 2 variants</summary><br>- %num_nodes=1<br>- %num_nodes=2</details> | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ |
...
| Metric | daint-maint | daint-prod | eiger-maint | eiger-prod | santis-maint | santis-prod | clariden-maint | clariden-prod | starlex-maint | starlex-prod |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| TOTAL (visible grouped rows) | 152 | 135 | 76 | 74 | 120 | 112 | 114 | 108 | 89 | 72 |
| TOTAL (raw ReFrame-selected tests) | 210 | 189 | 85 | 83 | 162 | 151 | 156 | 147 | 147 | 126 |